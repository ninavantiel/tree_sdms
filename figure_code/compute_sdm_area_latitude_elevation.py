...
if __name__ == '__main__':
    ...
    sdms_forest_area_lat_elev_fc = sdms_forest_area_lat_elev.map(lambda f: ee.Feature(f).setGeometry(ee.Geometry.Point([0,0])))
    export_table_to_asset(sdms_forest_area_lat_elev_fc, sdms_forest_area_lat_elev_asset_filename)
